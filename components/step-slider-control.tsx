...
export function StepSliderControl({ steps, stepIndex, onStepIndexChange }: StepSliderControlProps) {
  ...
  return (
    <div className="flex w-full flex-wrap items-center justify-end gap-2 md:gap-3">
      ...
      <div className="flex h-8 items-stretch overflow-hidden rounded-md border border-zinc-700 bg-black">
        <button
          type="button"
